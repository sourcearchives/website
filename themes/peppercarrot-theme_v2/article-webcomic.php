...
<div class="translabar col sml-12 sml-centered sml-text-center">
  <ul class="menu" role="toolbar">
    ...
    <li><a class="lang option" href="index.php?fr/article267/translation-tutorial"><img src="themes/peppercarrot-theme_v2/ico/add.svg" alt="+"/> <?php $plxShow->lang('ADD_TRANSLATION') ?></a></li>
  </ul>
</div>
