...
'CONTRIBUTE_TRANSLATION'	    => '
    ...
    <p> ペッパー&amp;キャロットウェブサイトは多言語対応のデザインになっていて、どの言語(既に使われなくなった言語でも、創作言語でも)も受け入れます。翻訳用のページのソースが用意されています。翻訳の追加方法については<a href="/article267/how-to-add-a-translation-or-a-correction">翻訳チュートリアル</a>を参照してください。</p>
',
