...
if(! defined('FILE_CACHE_TIME_BETWEEN_CLEANS'))	define ('FILE_CACHE_TIME_BETWEEN_CLEANS', 604800);	// How often the cache is cleaned , previous setting was 604800 = 7days, switched to test 172800 =48h, reverted
